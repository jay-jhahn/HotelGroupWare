 			...
 			<div class="col-md-12"> 
 				<div class="card"> 
					<div class="card-header">
						<div class="card-body">
						<form action="insertAction.al" method="post">
							  ...
							  <div> 
								<table class="table text-center"> 
								  ...
								  <tr>  										
									...
									style="width:130px;" name=""  placeholder="${vo.empName}" readonly ></td>
									<td> 부서 </td>
									<td><input type="text" class="animate__animated animate__fadeInUp form-control inputIdPwd mb-2" 
									style="width:130px;" name=""  placeholder="${vo.empCode}" readonly> </td>
 								  </tr>
 								</table>
 							</div>
								<div class="table-responsive"> 
 								<table class="table text-center"> 
								  <tr class="text-center backgray">  										
										...
										<tr><!-- 현재 1일은 01이 아닌 1로 뿌려짐 방법을 생각해 보기  -->
	 								   	<td> 
	 								   		<c:if test="${status.count <10 }">
	 								   			<input type="text" name="scheduleDate"  value="2021-03-0${status.count}" readonly> 
	 								   		</c:if>
	 								   	
	 								   		<c:if test="${status.count > 9 }" >
	 								   			<input type="text" name="scheduleDate"  value="2021-03-${status.count}" readonly> 
	 								   		</c:if>
	 								   	</td>
 								  ...
 								  <tr>
						        	<td colspan="3"><input type="submit" class="btn" style="background-color:#55789B; border-radius: 0rem;" value="입력하기" onclick="return insertScd()"></td>
 								  </tr>
 								</table> 
 								</div>
 							  </form>
