...
<span class="numNb"><b>101호</b></span>
   <div class="card">
      <table class="table">
         ...
         <tr>
         	<c:if test=${guestLevel == null && guestLevel == ""}>
	         	<td><span class="nb">고객 등급 : </span></td>
	            <td><input type="text" class="input" placeholder="없음" readonly>
	            	<input type="hidden" name="guestLevel" value="0">
	            </td>
         	</c:if>
         	<c:if test=${guestLevel == 2 && guestLevel == 3}>
	         	<td><span class="nb">고객 등급 : </span></td>
	            <td><input type="text" name="guestLevel" class="input" value="${guestLevel }" readonly></td>
         	</c:if>
